...
# Included in Gazee by Jessi Moss / Hubcaps with the following changes:
# urllib import changed for python 3 version
# Added Gazee specific logging throughout for debuging purposes
# Added return value to parseFilename function to provide needed info to Gazee ComicInfoParse function
# Original code hosted at https://github.com/davide-romanini/comictagger/
...
class FileNameParser:
    ...
    def parseFilename(self, filename):
        ...
        return {'series': self.series, 'issue': self.issue, 'volume': self.issue, 'remainder': self.remainder, 'year': self.year}
